...
export default class Hypertension extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      showmodal: false,
    ...
    const {gender,age}= this.props.route.params;
  }
  handleButtonPress = (value1) => {
    const { gender,age } = this.state;
    this.setState({ hypertension: value1 }, () => {
      // Navigate to the next screen with the parameter value
      this.props.navigation.navigate('Heart', { gender,age ,hypertension: value1 });
    });
  };
