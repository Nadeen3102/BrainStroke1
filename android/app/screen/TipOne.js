      ...
      <>
        <View style={styles.ImageWrapper}>
          <Image style={styles.TipImage}
            source={require('../../../image/TipOne.jpg')} />
        </View>
        ...
        <Text style={styles.TipDescription}>
          Today, take a few minutes to review the signs of brain strokes and discuss them with your loved ones.
        </Text>
        <TouchableOpacity onPress={() => {
              {this.props.navigation.navigate("TipTwo")}}} >
